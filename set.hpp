...
namespace ft
{
	...
	public:
		...
		set() : _M_t(key_compare(), allocator_type()) {}
		explicit set(const key_compare &comp, const allocator_type &alloc = allocator_type()) : _M_t(comp, alloc)
		{
			(void)comp;
			(void)alloc;
		}
